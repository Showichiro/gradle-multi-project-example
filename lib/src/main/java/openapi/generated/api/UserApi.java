...
import openapi.generated.model.User;
...
public interface UserApi {
    ...
    @ResponseStatus(HttpStatus.OK)
    default User createUsersWithListInput(
    ...
    default String loginUser(
        @Parameter(name = "username", description = "The user name for login", in = ParameterIn.QUERY) @Valid @RequestParam(value = "username", required = false) Optional<String> username,
        @Parameter(name = "password", description = "The password for login in clear text", in = ParameterIn.QUERY) @Valid @RequestParam(value = "password", required = false) Optional<String> password
    ) {
        throw new IllegalArgumentException("Not implemented");
